      ...
      <div className="flex gap-2 items-start pb-5 flex-col-reverse lg:flex-row">
        <div className="flex flex-col gap-2 w-full">
          {projects.map(({ title, description, image, actions }, i) => <div key={i} className="w-full rounded-xl bg-primary-700 flex-col flex border border-primary-400/20">
            <Image
              ...
              height={0}
            />
            <div className="flex flex-col gap-2 p-5 select-none">
        ...
        <div className="side-piece">
          ...
          <div className="flex flex-wrap gap-2">
            <a href="https://discord.com/users/582170007505731594" target="_blank" className="button button-primary w-full">
            ...
            <a href="https://open.spotify.com/user/k357aopsqp612md25nbd17ps4?si=b3e90c555c35450f" target="_blank" className="button button-primary w-full">
              <svg fill="currentColor" width="24" height="24" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.66 0 12 0zm5.521 17.34c-.24.359-.66.48-1.021.24-2.82-1.74-6.36-2.101-10.561-1.141-.418.122-.779-.179-.899-.539-.12-.421.18-.78.54-.9 4.56-1.021 8.52-.6 11.64 1.32.42.18.479.659.301 1.02zm1.44-3.3c-.301.42-.841.6-1.262.3-3.239-1.98-8.159-2.58-11.939-1.38-.479.12-1.02-.12-1.14-.6-.12-.48.12-1.021.6-1.141C9.6 9.9 15 10.561 18.72 12.84c.361.181.54.78.241 1.2zm.12-3.36C15.24 8.4 8.82 8.16 5.16 9.301c-.6.179-1.2-.181-1.38-.721-.18-.601.18-1.2.72-1.381 4.26-1.26 11.28-1.02 15.721 1.621.539.3.719 1.02.419 1.56-.299.421-1.02.599-1.559.3z" />
              </svg>
              DaBluLite
            </a>
            <a href="https://tidal.com/browse/user/197201549" target="_blank" className="button button-primary w-full">
            ...
            <a href="https://steamcommunity.com/id/dablulite/" target="_blank" className="button button-primary w-full">
              <svg fill="currentColor" width="24" height="24" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <a target="_blank" className="button button-primary w-full">
              <svg fill="currentColor" width="24" height="24" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg w-full">
            ...
            <a href="https://github.com/DaBluLite/" target="_blank" className="button button-primary w-full">
              <svg fill="currentColor" width="24" height="24" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg w-full">
            ...
            <a href="https://github.com/ProjectColorway" target="_blank" className="button button-primary w-full">
              <svg fill="currentColor" width="24" height="24" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg w-full">
                <path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12" />
              </svg>
              Project Colorway
