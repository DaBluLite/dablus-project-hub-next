    ...
    <html lang="en">
      ...
      <body className={`${geistSans.variable} ${geistMono.variable} h-[100vh] flex bg-primary-500`}>
        <div className="relative flex w-full flex-col font-schibsted bg-primary-500">
          <nav className="fixed top-0 right-0 left-0 isolate z-[9999] mx-auto flex h-[5.5rem] w-full shrink-0 flex-row items-center px-2 py-4 lg:py-5">
            <div className="relative mx-auto flex h-full w-full max-w-[70rem] flex-row items-center justify-between gap-8 rounded-sm transition-all bg-primary-700 px-2">
          ...
          <div className="px-2">
            <div className={`flex flex-col max-w-[70rem] mx-auto grow pt-[88px] gap-2`}>
              {children}
            </div>
          </div>
        </div>
