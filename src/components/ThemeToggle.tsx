...
export default function ThemeToggle() {
  ...
  return (
    <button
        ...
        className="bg-white/60 dark:bg-accent-800/20 hover:bg-primary-50/60 dark:hover:bg-accent-800/60 flex items-center gap-2 p-3 rounded-full cursor-pointer border-1/2 border-primary-700/20 dark:border-accent-700/20 shadow-sm shadow-primary-700/10 dark:shadow-black/10 md:border transition-colors"
